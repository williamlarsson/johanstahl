...
/***/ (function(module, exports, __webpack_require__) {
	...
	const Papa = __webpack_require__(5);
	...
	function App() {
	    ...
	    function htmlString(title,client, image, embed, info, size){
	        return `<div class="portfolio_image ${size}-width" data-url='${JSON.stringify(embed)}'
	            data-title="${title}" style="background-image: url('img/${image}');" data-hash="${title.toLocaleLowerCase().replace(/ /g,'-')}">
